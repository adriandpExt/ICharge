  ...
  return (
    <section>
      ...
      <PageContainer className="space-y-10">
        <Card className="rounded-3xl border-none bg-gradient-to-b from-[#e0eddf] via-[#d9e3da] to-[#e6e8e6] p-2 lg:p-5">
          <CardHeader>
            <Label
              variant={"heading2"}
        ...
        <Card className="rounded-3xl border-none bg-gradient-to-b from-[#e0eddf] via-[#d9e3da] to-[#e6e8e6] p-2 lg:p-5">
          ...
          >
            <Label variant={"body"}>
              Done charging? Simply drop your iCharge power bank at any station,
              and your deposit will be refunded instantly! No waiting, no hassle
              just effortless charging on the go.
            </Label>
