    ...
    <section className="grid h-[90vh] w-full place-items-center lg:grid-cols-2">
      ...
      >
        <div className="flex flex-col gap-1">
          ...
          >
            Stay
            <span className="ml-3 inline-block min-w-[150px] bg-gradient-to-r from-[#44D62C] via-[#54575A] to-[#fff] bg-clip-text text-transparent md:min-w-[300px] lg:min-w-[400px]">
              <TypeAnimation
